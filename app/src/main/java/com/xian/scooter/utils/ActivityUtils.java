...
public final class ActivityUtils {
    ...
    private static final LinkedList<Activity> listActivity = new LinkedList<>();
    ...
    private static void setTopActivity(final Activity activity) {
        if (listActivity.contains(activity)) {
            if (!listActivity.getLast().equals(activity)) {
                listActivity.addLast(activity);
            }
        } else {
            listActivity.addLast(activity);
        }
    ...
    static Activity getTopActivity() {
        if (!listActivity.isEmpty()) {
            final Activity topActivity = listActivity.getLast();
            if (topActivity != null) {
                return topActivity;
            }
        }
...
//        for (Activity activity : getListActivity()) {
//            if (!(activity instanceof LoginActivity)) {
//                activity.finish();
//            }
//        }
//        getListActivity().clear();
//    }

    public static void appToForeground(Context context) {
        ...
        for (ActivityManager.RunningTaskInfo rti : taskList) {
            ...
            if (rti.topActivity.getPackageName().equals(context.getPackageName())) {
                ...
                ComponentName cn = new ComponentName("com.bit.communityOwner", rti.topActivity.getClassName());
