...
public class PreferenceUtils {
    ...
    private static final String SP_NAME = BaseApplication.getInstance().getPackageName();

    private SharedPreferences sp;

    public PreferenceUtils(Context ctx) {
        if (ctx == null) {
    ...
    public static synchronized PreferenceUtils get() {
        if (instance == null) {
            synchronized (PreferenceUtils.class) {
                if (instance == null) {
                    instance = new PreferenceUtils(BaseApplication.getInstance().getApplicationContext());
                }
            }
        }
        return instance;
